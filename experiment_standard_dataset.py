...
def save_models(args, mod_to_name_map):
...
if __name__ == "__main__":
    ...
    if args.strategy == 1:
        variable = ('dataset', 'col', 'method', 'upic', 'pic')
    else:
        variable = ('dataset', 'method', 'upic', 'pic')
